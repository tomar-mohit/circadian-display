...
class OverlayDisplayController
    ...
    constructor(
        ...
        private fun getOrCreateDimmingView(): View = dimmingView ?: createOverlayView().also { dimmingView = it }

        private fun getOrCreateWarmthView(): View = warmthView ?: createOverlayView().also { warmthView = it }
